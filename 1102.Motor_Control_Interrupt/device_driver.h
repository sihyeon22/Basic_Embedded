...
extern void TIM2_Motor_Out_Init(void);
extern void TIM2_Motor_Out_Freq_Generation(unsigned short freq, float duty);
extern void TIM2_Motor_Run(int dir, float duty);
extern void TIM2_Motor_Stop(void);

// Motor.c

extern void FWD_Init(unsigned int freq);
extern void BWD_Init(unsigned int freq);
extern void Control_Init(void);
extern void PWM_Motor_Run(int dir, unsigned int freq, unsigned short duty);
